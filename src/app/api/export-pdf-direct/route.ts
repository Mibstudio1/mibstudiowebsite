...
export async function POST(req: Request) {
  try {
    ...
    try {
      // Try Puppeteer with local font first
      console.log("Attempting PDF generation with Puppeteer and local font...");
      ...
      console.log("PDF generated successfully with Puppeteer and local font, size:", pdf.length);
      ...
      console.error("Puppeteer with local font failed, trying Google Fonts:", puppeteerError);
      
      try {
        // Try Puppeteer with Google Fonts
        console.log("Attempting PDF generation with Google Fonts...");
        ...
        console.error("Google Fonts failed, falling back to jsPDF:", googleFontsError);
        ...
        console.log("PDF generated with jsPDF fallback, size:", pdfUint8Array.length);
    ...
    return NextResponse.json(
      { 
        error: `Failed to generate PDF, Error: All methods failed to generate PDF`,
        details: {
